<?php
	...
	$backErrorUrl='<a href="./announcements_college_bachelor.php">Попробовать ещё раз</a><br>';
	...
	*/
	...
	$stmt=$pdo->prepare("INSERT INTO bachelor_college_announcements SET announcement_time=?, announcement_text=?, announcement_notification_status=?");
	...
	$myfile = fopen("./php/bachelor_college_announcements.json", "w");
	fwrite($myfile,json_encode($response));
	fclose($myfile);
	echo 'OK!<br>';
	echo '<a href="./bachelor_college_announcements.php">Добавить ещё одно объявление</a>';
?>
