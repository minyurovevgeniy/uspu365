...
<html>
	<head>
		...
		<script type="text/javascript" src="./js/timetableMagisterExamManagement.js"></script>
	</head>
	<body>
		<div id="header">
		<?include("./header.php"); ?>
		...
		<div id="content">
			<h1>Расписание вступительных испытаний в магистратуре</h1>
			<iframe src="./loadMagisterExamTimetable.php"></iframe>
			<div id="timetable">
				<table>
