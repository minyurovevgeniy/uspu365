...
<html>
	...
	<body>
		<div id="header"></div>
		<div id="content">
			<h1>Загрузка информации о ЕГЭ</h1>
			<form action="./loadEGE_result.php" method="post" enctype="multipart/form-data">
					<table>
						<tr>
						...
						<tr>
							...
							<td>Номер колонки с названием предмета</td><td><input type="text" name="fullEGEname"></td>
						</tr>
						</tr>
							<td>Номер колонки с сокращением</td><td><input type="text" name="abbreviation"></td>
						</tr>
            </tr>
              <td>Номер колонки с минимальным баллом ЕГЭ</td><td><input type="text" name="minEGEvalue"></td>
            </tr>
						<tr>
