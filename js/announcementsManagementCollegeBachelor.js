$(function ()
{
	$.ajax(
		{
			type: "GET",
			url: "../php/refreshAnnouncementsCollegeBachelor.php",
			dataType: "json",
	...
	$('body').on("click",".save",function()
	{
		...
		$.ajax(
		{
			type: "POST",
			data:dataToSend,
			url: "../php/saveAnnouncementCollegeBachelor.php",
			dataType: "json",
			success: function(response)
			{
				alert("ok");
	...
	$('body').on("click",".delete",function()
	{
		...
		{
			type: "POST",
			url: "../php/deleteAnnouncementCollegeBachelor.php",
			dataType: "json",
			data:dataToSend,
			success: function(response)
			{
	...
	$('body').on("click","#deleteAllAnnouncements",function()
	{
		...
		{
			type: "POST",
			url: "../php/deleteAllAnnouncementsCollegeBachelor.php",
			dataType: "json",
			success: function(response)
			{
	...
	$('body').on("click","#deleteAllRecepients",function()
	{
		...
		{
			type: "POST",
			url: "../php/deleteRecipientsCollegeBachelor.php",
			dataType: "json",
			success: function(response)
			{
				alert("OK!");
