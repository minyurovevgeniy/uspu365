    ...
    if ($shouldDisplay>0)
    {
      ...
      $timetable['exams'][]=
        ...
        (
          ...
          'start_time'=>(string)$row['spo_exam_start_time'],
          'end_time'=>(string)$row['spo_exam_end_time'],
          'room'=>(string)iconv("cp1251","utf8",$row['spo_exam_room']),
          'notes'=>(string)iconv("cp1251","utf8",$row['spo_exam_notes']),
