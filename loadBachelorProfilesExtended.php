...
<html>
	...
	<body>
		<div id="header"></div>
		<div id="content">
			<form action="./loadBachelorProfilesExtended_result.php" method="post" enctype="multipart/form-data">
					<table>
						<tr>
						...
						<tr>
							<td>Номер колонки с категорией приема</td><td><input type="text" name="profile_special_column"></td>
						</tr>
						<tr>
							<td>Номер колонки с количеством мест</td><td><input type="text" name="profile_capacity_column"></td>
						</tr>
						<tr>
							<td>Номер колонки с набором ЕГЭ</td><td><input type="text" name="ege_set_column"></td>
						</tr>
						<tr>
