...
<html>
	<head>
		<title>Объявления СПО бакалавриата</title>
		<link rel="stylesheet" href="./css/bootstrap.min.css">
		<link rel="stylesheet" href="./css/common.css">
		<link rel="stylesheet" href="./css/announcements.css">
		<script type="text/javascript" src="./js/jquery.js"></script>
		<script type="text/javascript" src="./js/announcementsManagementCollegeBachelor.js"></script>
	</head>
	<body>
		<div id="header">
		<?include("./header.php"); ?>
		...
		<div id="content">
			<h1>Объявления СПО бакалавриата</h1>

			<iframe src="./announcements_college_bachelor.php"></iframe>
